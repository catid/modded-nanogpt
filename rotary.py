...
class RotaryEmbedding(Module):
    def __init__(
        ...
        # Only make freqs a parameter if learned_freq is True, otherwise register as buffer
        if learned_freq:
            self.freqs = nn.Parameter(freqs)
        else:
            self.register_buffer('freqs', freqs, persistent=True)  # Keep persistent=True for backwards compatibility
